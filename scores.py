...
echonet_parameters   = dict({"n_train":700, 
                             "batch_size":32,
                             "train_frac":0.6,
                             "val_frac":0.1,
                             "learning_rate":0.001,
...
def run_one_benchmark(backbone_architecture, backbone_model, task_code, **kwargs):
    ...
    benchmark_task.run(freeze_backbone=False)
...
def ETABscore(backbone_architecture, backbone_model, task_weights=None):
    ...
    for task_key in ETAB_benchmark_tasks.keys():
        ...
        benchmark_score_           = run_one_benchmark(backbone_architecture, backbone_model, task_key, **ETAB_benchmark_tasks[task_key])
