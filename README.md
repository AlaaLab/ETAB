...
```python
$ python run_benchmark.py --task <Task Code> --backbone <Backbone representation> --head <Task-specific head> --freeze_backbone <Boolean = Fully finetune?> \
                          --train_frac <fraction of data used for training> --val_frac <fraction of data used for validation> --lr <learning rate> --epochs <number of epochs> --batch <batch size> 
```
